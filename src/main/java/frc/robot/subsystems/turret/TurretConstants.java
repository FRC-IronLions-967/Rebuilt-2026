...
public class TurretConstants {
    ...
    public static final double hoodOffset = 0.291; //used when encoder gets messed up
    public static final double hoodMaxAngle = 0.616 + hoodOffset;//.616
    public static final double hoodMinAngle = 0.239 + hoodOffset;//239
